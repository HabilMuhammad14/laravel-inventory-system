...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .badge-stok{display:inline-block;padding:2px 8px;border-radius:5px;font-size:12px;font-weight:500}
    .badge-stok.ok{background:#dcfce7;color:#16a34a}
    .badge-stok.low{background:#fef9c3;color:#854d0e}
    .badge-stok.empty{background:#fee2e2;color:#b91c1c}
...
<div class="sidebar" id="sidebar">
  ...
  <nav class="nav">
    ...
    <a class="nav-item active" href="{{ route('laporan-stok.index') }}">
  ...
  <div class="content">
    <div class="page-header">
      <div>
        ...
        <div class="page-sub">Informasi stok barang masuk dan keluar.</div>
      </div>
      ...
      <table class="tabel">
        <thead>
          <tr>
            ...
            <th class="num" style="width:100px">Masuk</th>
            <th class="num" style="width:100px">Keluar</th>
            <th class="num" style="width:80px">Retur</th>
            <th class="num" style="width:100px">Stok Akhir</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="num">
              <span class="badge-stok {{ $badgeClass }}">{{ $stokAkhir }}</span>
            </td>
          </tr>
          @endforeach
        </tbody>
