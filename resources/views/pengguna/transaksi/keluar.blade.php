...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .tabel{width:100%;border-collapse:collapse;font-size:13px;min-width:720px}
...
<div class="sidebar" id="sidebar">
  ...
  <nav class="nav">
    ...
    <a class="nav-item active" href="{{ route('transaksiKeluar.index') }}">
        ...
        <tbody>
          ...
          <form action="{{route('transaksiKeluar.store')}}" method="POST">
            ...
            <tr class="form-row">
              ...
              <td><input type="text" class="form-input" placeholder="TK011" name="kode_transaksi_keluar"></td>
          ...
          @foreach ($transaksis as $transaksi)
            @if(isset($editTransaksi) && $editTransaksi->id == $transaksi->id)
              ...
              <form action="{{route('transaksiKeluar.update', $transaksi)}}" method="POST">
                ...
                <tr class="edit-row">
                  ...
                  <td>
                    <input type="text" class="form-input {{ $errors->has('kode_transaksi_keluar') ? 'input-error' : '' }}" name="kode_transaksi_keluar" value="{{ old('kode_transaksi_keluar', $transaksi->kode_transaksi_keluar) }}">
                    @error('kode_transaksi_keluar')<span class="error-text">{{ $message }}</span>@enderror
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="aksi-group">
                      ...
                      <a href="{{route('transaksiKeluar.index')}}" class="btn-batal">Batal</a>
                    </div>
                  </td>
                </tr>
              </form>
            ...
            @else
              ...
              <tr>
                ...
                <td>
                  <div class="aksi-group">
                    <a href="{{route('transaksiKeluar.edit', $transaksi)}}" class="btn-edit">Edit</a>
                    <a href="{{route('transaksiKeluar.hapus', $transaksi)}}" class="btn-hapus">Hapus</a>
                  </div>
                </td>
              </tr>
