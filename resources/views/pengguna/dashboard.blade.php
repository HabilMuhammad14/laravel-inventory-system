...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .page-title{font-size:28px;font-weight:300;color:#333;margin-bottom:6px}
    .page-sub{font-size:13.5px;color:#999;margin-bottom:28px}

    .grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px}
    .card{background:#fff;border:1px solid #e5e5e5;border-radius:12px;padding:22px 20px;text-decoration:none;color:#333;display:flex;flex-direction:column;gap:10px;transition:box-shadow .15s,border-color .15s}
    .card:hover{box-shadow:0 4px 16px rgba(0,0,0,.07);border-color:#c7d9f8}
    .card-icon{width:40px;height:40px;background:#dbeafe;border-radius:10px;display:flex;align-items:center;justify-content:center}
    .card-icon svg{width:20px;height:20px;stroke:#1a56db;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
    .card-label{font-size:14px;font-weight:600;color:#222}
    .card-desc{font-size:12.5px;color:#999;line-height:1.4}
  ...
  <div class="content">
    ...
    <div class="grid">
      <a class="card" href="">
        ...
        <div class="card-label">Barang</div>
        <div class="card-desc">Kelola data barang toko</div>
      </a>
      <a class="card" href="">
        <div class="card-icon">
          <svg viewBox="0 0 24 24"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>
        ...
        <div class="card-desc">Kelola transaksi toko</div>
      </a>
      <a class="card" href="">
        <div class="card-icon">
          <svg viewBox="0 0 24 24"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
        ...
        <div class="card-desc">Kelola data supplier</div>
      </a>
      <a class="card" href="">
        <div class="card-icon">
          <svg viewBox="0 0 24 24"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
        </div>
        <div class="card-label">Stok Barang</div>
        <div class="card-desc">Lihat kondisi stok terkini</div>
      </a>
    </div>
  </div>
</div>
