...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .tabel{width:100%;border-collapse:collapse;font-size:13px;min-width:780px}
    ...
    .badge-jenis{display:inline-block;padding:3px 10px;border-radius:20px;font-size:11.5px;font-weight:500}
    .badge-jenis.masuk{background:#dcfce7;color:#16a34a}
    .badge-jenis.keluar{background:#fee2e2;color:#b91c1c}
    .badge-jenis.retur{background:#fef9c3;color:#854d0e}
...
<div class="sidebar" id="sidebar">
  ...
  <nav class="nav">
    ...
    <a class="nav-item active" href="{{route('pemilik.laporan-transaksi')}}">
  ...
  <div class="content">
    <div class="page-header">
      <div>
        ...
        <div class="page-sub">Informasi seluruh transaksi barang masuk, keluar, dan retur.</div>
      </div>
      ...
      <table class="tabel">
        <thead>
          <tr>
            ...
            <th style="min-width:130px">Barang</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="badge-id">{{ $t->kode }}</span></td>
            <td>{{ $t->tanggal }}</td>
            <td><span class="badge-jenis {{ $t->jenis }}">{{ ucfirst($t->jenis) }}</span></td>
            <td>{{ $t->barang->nama_barang ?? '-' }}</td>
            <td>{{ $t->jumlah }}</td>
            <td>{{ $t->supplier->id_supplier ?? '-' }}</td>
            <td>{{ $t->user->name ?? '-' }}</td>
            <td>{{ $t->keterangan }}</td>
          </tr>
          @empty
          <tr>
            <td colspan="9" style="text-align:center;color:#aaa;padding:20px">Belum ada data transaksi</td>
          </tr>
          @endforelse
        </tbody>
      </table>
